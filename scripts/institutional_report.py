...
def create_pdf(output_path="outputs/Institutional_Report.pdf", base_path="data"):
    ...
    add_bullet_notes(
        pdf,
        [
            "- Institutional investors are contacts and accounts where 'Contact Type' and 'Account Type' are marked 'Institutional' in js_contacts.csv and Accounts.csv respectively.",
            "- Mean and median investment are calculated from 'Committed amount' for those institutional contacts.",
            "- Top 20 table ranks institutional investors by summed committed amount.",
